...
<section class="page-section portfolio" id="portfolio">
  <div class="container">
    ...
    <div class="row">
      ...
      @foreach ($wishlists as $wishlist) @foreach ($fragances as $fragance) @if ($wishlist->getFragance_id() == $fragance->getId())
      <div class="col-md-6 col-lg-4 mb-5">
        ...
        <form action="{{ route('wishlist.delete', $fragance->getId()) }}" method="POST">
          ...
          <button type="submit" class="btn btn-outline-success btn-block mt-2 col-25">
            {{ __("home.delete-wish") }}<i class="fa far fas fa-heart"></i>
          </button>
        </form>
        @endif
      </div>
